...
@HippoEssentialsGenerated(internalName = "channelpagesupdemo:bannerdocument")
@Node(jcrType = "channelpagesupdemo:bannerdocument")
public class Banner extends BaseDocument {
	...
	public HippoGalleryImageSet getImage() {
		return getLinkedBean("channelpagesupdemo:image", HippoGalleryImageSet.class);
	}

	@HippoEssentialsGenerated(internalName = "channelpagesupdemo:link")
	public HippoBean getLink() {
		return getLinkedBean("channelpagesupdemo:link", HippoBean.class);
	}
}
