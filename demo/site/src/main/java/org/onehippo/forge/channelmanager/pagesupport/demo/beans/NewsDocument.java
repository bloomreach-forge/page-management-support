...
@HippoEssentialsGenerated(internalName = "channelpagesupdemo:newsdocument")
@Node(jcrType="channelpagesupdemo:newsdocument")
public class NewsDocument extends HippoDocument {

    /**
     * The document type of the news document.
     */
    public final static String DOCUMENT_TYPE = "channelpagesupdemo:newsdocument";
    ...
    private final static String AUTHOR = "channelpagesupdemo:author";
    private final static String SOURCE = "channelpagesupdemo:source";
     ...
     * @return the author
     */
    @HippoEssentialsGenerated(internalName = "channelpagesupdemo:author")
     ...
     * @return the source
     */
    @HippoEssentialsGenerated(internalName = "channelpagesupdemo:source")
